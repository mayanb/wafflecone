...
class TestAttributes(APITestCase):
	...
	def test_move_attribute(self):
		...
		self.assertEqual(old_attribute_1.rank, 1)
		self.assertEqual(old_attribute_2.rank, 2)
		self.assertEqual(old_attribute_3.rank, 3)
		...
		self.assertEqual(new_attribute_1.rank, 2)
		self.assertEqual(new_attribute_2.rank, 1)
		self.assertEqual(new_attribute_3.rank, 3)
